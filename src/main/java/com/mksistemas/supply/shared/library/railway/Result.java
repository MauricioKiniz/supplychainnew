...
import com.mksistemas.supply.shared.library.railway.Helper.Unit;
...
public final class Result<TFailure, TSuccess> {
	...
	public <TResult> TResult onFailureThrow(Function<TFailure, RuntimeException> failureFunc,
			Function<TSuccess, TResult> successFunc) {
		if (isFailure)
